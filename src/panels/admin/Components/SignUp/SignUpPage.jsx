...
const SignUpPage = () => {
  ...
  const handleSignUp = (e) => {
    ...
    // Validation
    if (!companyName || !fullName || !phoneNumber || !email || !password) {
    ...
    <div className="signup-container">
      <div className="signup-content">
        ...
        <div className="header-container">
          ...
          <p className="subtitle">Start managing your water delivery operations today</p>
        </div>

        {/* Sign Up Form Card */}
        <div className="form-card">
          <h2 className="welcome-text">Create Your Account</h2>
          <p className="signup-text">Enter your details to get started</p>
